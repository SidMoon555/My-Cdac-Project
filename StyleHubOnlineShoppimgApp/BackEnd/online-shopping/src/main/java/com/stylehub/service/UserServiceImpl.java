...
import com.stylehub.dao.AddressDao;
...
public class UserServiceImpl implements UserService{
    ...
    emailService.sendEmailAsync(newUser.getEmailId(), "Registration", "Hi "+newUser.getFirstName().toUpperCase()+" "+newUser.getLastName().toUpperCase()+ " Thank you for registrating with STYLE-HUB..!!");
